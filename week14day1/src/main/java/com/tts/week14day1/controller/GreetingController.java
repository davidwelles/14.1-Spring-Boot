...
public class GreetingController {
    ...
    // the path variable here will be part of the endpoint and be called http://localhost:8080/greeting/var/david
    ...
    //This is a more flexible way of doing it and easier to use and will be called like http://localhost:8080/greeting?name=david
